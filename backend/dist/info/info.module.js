...
const info_providers_1 = require("./info.providers");
const database_module_1 = require("../model/database.module");
...
exports.InfoModule = InfoModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [...info_providers_1.infoProviders, info_service_1.InfoService],
    })
], InfoModule);
